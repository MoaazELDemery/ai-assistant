export const ENV = {
    ...
    API_CALLBACK_URL: process.env.EXPO_PUBLIC_API_CALLBACK_URL || 'https://ungravelly-lydia-thornily.ngrok-free.dev',
    ...
    // STT Provider
    STT_PROVIDER: (process.env.EXPO_PUBLIC_STT_PROVIDER as 'openai' | 'self-hosted') || 'openai',
    STT_SELF_HOSTED_URL: process.env.EXPO_PUBLIC_STT_SELF_HOSTED_URL || 'http://192.168.1.12:8000',
